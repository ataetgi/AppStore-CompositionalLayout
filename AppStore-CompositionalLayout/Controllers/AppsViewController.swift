...
class AppsViewController: UIViewController {
    ...
    var dataSource: UICollectionViewDiffableDataSource<Section, App>? // automaticlly manages data in collectionview using snapshots
    ...
    func reloadData() {
        var snapshot = NSDiffableDataSourceSnapshot<Section, App>() // class that holds all the data in our collectionview, visible or othervise
    ...
    func createCompositionalLayout() -> UICollectionViewLayout {
        ...
        let layout = UICollectionViewCompositionalLayout { sectionIndex, layoutEnvrioment in
...
struct Apps_Preview: PreviewProvider {
    static var previews: some View {
        ContainerView().edgesIgnoringSafeArea(.all).preferredColorScheme(.light)
//        ContainerView().edgesIgnoringSafeArea(.all).preferredColorScheme(.dark)
    }
